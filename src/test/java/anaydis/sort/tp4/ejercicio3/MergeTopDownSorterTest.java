...
public class MergeTopDownSorterTest {

    private final DataSetGenerator<Integer> generator = new IntegerDataSetGenerator();
    private final MergeTopDownSorter sorter = (MergeTopDownSorter) new SorterProviderImpl().getSorterForType(SorterType.MERGE_TOP_DOWN);
