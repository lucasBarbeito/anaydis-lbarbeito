...
public class QuickNonRecursiveSorterTest {

    private final DataSetGenerator<Integer> generator = new IntegerDataSetGenerator();
    private final QuickNonRecursiveSorter sorter = (QuickNonRecursiveSorter) new SorterProviderImpl().getSorterForType(SorterType.QUICK_NON_RECURSIVE);
