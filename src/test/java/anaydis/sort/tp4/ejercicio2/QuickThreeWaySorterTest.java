...
public class QuickThreeWaySorterTest {

    private final DataSetGenerator<Integer> generator = new IntegerDataSetGenerator();
    private final QuickThreeWaySorter sorter = (QuickThreeWaySorter) new SorterProviderImpl().getSorterForType(SorterType.QUICK_THREE_PARTITION);
